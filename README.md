...
(the pre-commit hook then skips its checks with a warning instead of running them).
Run this first in every new worktree to symlink the shared secrets from your main
