...
| [014](./014-layered-feature-module-pattern.md) | The layered feature-module pattern: `src/features/<feature>/<layer>/` + sublayer/feature barrels + seam boundaries | Accepted | `eslint-plugin-boundaries` (TIM-135) lands and wants to adjust the shape, or a feature's axis needs a sublayer the pattern doesn't name |
