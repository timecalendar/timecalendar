...
export function SchoolAbout({ university }: SchoolAboutProps) {
  const stats = [
    {
      icon: Users,
    ...
    {
      icon: BookOpen,
      value: `${university.domains.length}`,
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-12">
          <div className="space-y-6">
            ...
            <p className="text-gray-700 leading-relaxed">
              Reconnue pour la qualité de son enseignement et de sa recherche,
              l&apos;{university.name}
              forme chaque année des milliers d&apos;étudiants dans des domaines
              variés. Son emplacement stratégique en fait un choix privilégié
              pour les étudiants souhaitant allier études de qualité et
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              {university.name} dans une interface claire et moderne, pour que
              vous ayez toujours l&apos;information qu&apos;il vous faut, au bon
              moment.
            </p>
