...
retryable_case nested_live_failed_wrapper 'the captured nested live-wrapper shape'
...
terminal_case same_depth_failed_wrapper 60 'a same-depth FAILED runFlow wrapper'
same_depth_wrapper_fixture="$fixture"

terminal_case closed_failed_wrapper 61 'a FAILED runFlow wrapper closed before the final command'
closed_wrapper_fixture="$fixture"

terminal_case failed_child_assertion_under_live_wrapper 62 'a FAILED child assertion beneath a live wrapper'

terminal_case failed_child_interaction_under_live_wrapper 63 'a FAILED child interaction beneath a live wrapper'

terminal_case failed_non_wrapper_ancestor 64 'a lower-depth FAILED command that is not runFlow'
