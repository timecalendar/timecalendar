...
assert_count 2 'github.event.pull_request.head.sha || github.sha'
assert_count 2 'ghcr.io/timecalendar/timecalendar:${{ env.E2E_SOURCE_SHA }}'
assert_present 'E2E_SERVER_IMAGE: ghcr.io/timecalendar/timecalendar:${{ github.event.pull_request.head.sha || github.sha }}'
