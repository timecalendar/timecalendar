...
// advances Drizzle's __drizzle_migrations tracking table, applying any of the
// committed migrations bundle not yet recorded (idempotent — a subsequent run
// with nothing new to apply is a no-op). A failure is crash-worthy, so it is
