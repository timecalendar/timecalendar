...
export const STORAGE_KEYS = {
  ...
  onboardingResolution: "firstLaunch.onboardingResolution",
  firstIcalReminderState: "firstLaunch.firstIcalReminderState",
...
export const STORAGE_KEY_CLASSIFICATION = {
  ...
  [STORAGE_KEYS.onboardingResolution]: "environment-independent",
  [STORAGE_KEYS.firstIcalReminderState]: "environment-independent",
