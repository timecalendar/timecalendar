...
class _HiddenEventsScreenState extends State<HiddenEventsScreen> {
  List<DeprecatedEvent> hiddenUidEvent = [];
  ...
  void initState() {
    ...
    Future.delayed(Duration.zero, () {
      setState(() {
        this.hiddenUidEvent =
            List<DeprecatedEvent>.from(eventProvider.eventsUidHidden);
  ...
  void removeHiddenUidEvent(BuildContext context, int index) async {
    ...
    setState(() {
      this.hiddenUidEvent = List<DeprecatedEvent>.from(hiddenUidEvent)
        ..removeAt(index);
    });
  }
