...
| [D04 — Use owned native views with UI-thread gestures](./D04-view-renderer-and-gestures.md)                          | RN views, native scroll/pager and UI-thread header; validate pinch | Compare alternatives if measured behavior fails                   |
