...
| Native CI target                | Exact candidate selected by run 34194654241                       |
...
| G9   | Exact-candidate Activity Maestro journey on Android and iOS                                          | Manual workflow selected the exact candidate; both platform jobs are pending                                     | Both platform jobs pass the complete flow                              | Native run 34194654241                     | FAIL    |
...
| Immutable environment telemetry window | Bounded negative queries against the exact deployed image                     | No deployed immutable candidate was available without a rollout action    | Zero marker-category matches                        | [TIM-532](/TIM/issues/TIM-532)   | FAIL    |
...
| Previous mobile release against candidate server | Candidate-bound compatibility exercise                | No immutable preproduction candidate was deployed                           | Valid legacy request remains compatible               | [TIM-532](/TIM/issues/TIM-532)       | FAIL    |
...
| Native Android                 | Exact-candidate platform job pending                                                               | Activity journey passes | Native run 34194654241          | FAIL    |
| Native iOS                     | Exact-candidate platform job pending                                                               | Activity journey passes | Native run 34194654241          | FAIL    |
...
automated gates. Exact-candidate native jobs remain pending, and the candidate has no authorized
immutable-environment telemetry window or previous-mobile-release compatibility exercise.
[TIM-532](/TIM/issues/TIM-532) owns those environment-bound rows. Activity remains unapproved for
production until the pending native results and both separately authorized environment rows pass
