...
class SchoolsApi {
  ...
  Future<Response<GetSchoolGroupsIcalUrlRepDto>> getSchoolGroupsIcalUrl({
    ...
    try {
      const _type = FullType(GetSchoolGroupsIcalUrlDto);
  ...
  Future<Response<void>> setSchoolGroups({
    ...
    try {
      const _type = FullType(SetSchoolGroupDto);
      _bodyData =
  ...
  Future<Response<void>> getIcalUrlFromStudentNumber({
    ...
    final _path = r'/schools/univ-orleans/students';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(OrleansGetIcalUrlFromStudentNumberDto);
