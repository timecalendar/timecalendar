...
class CalendarsApi {
  ...
  const CalendarsApi(this._dio, this._serializers);

  /// Find a calendar by its token
  ///
  ///
  /// Parameters:
  /// * [token] - The calendar token
  ...
  Future<Response<CreateCalendarRepDto>> createCalendar({
    ...
    try {
      const _type = FullType(CreateCalendarDto);
      _bodyData =
  ...
  Future<Response<BuiltList<CalendarWithContent>>> syncCalendars({
    ...
    try {
      const _type = FullType(SyncCalendarsDto);
      _bodyData =
