# android-build-config Specification

## Purpose
Captures the build-configuration requirements for the Android side of the
Flutter app: which Gradle repositories are used and which Firebase tooling
plugins are pinned. This keeps the Android build off dead/end-of-life
infrastructure (e.g. JCenter) and on maintained tooling.
## Requirements
