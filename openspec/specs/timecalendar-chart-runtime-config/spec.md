...
- **AND** it identifies the corresponding `lyrolab/platform/kubernetes/clusters/<cluster>/20-apps/timecalendar-*/env-sealed-secret.yaml` files as the source of that allocation
