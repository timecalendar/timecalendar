# mobile-build-infrastructure-guidance Specification

## Purpose

Defines the documented trust boundaries, workflow contracts, cache policy, distribution provenance,
and evidence gates for TimeCalendar's hybrid mobile build infrastructure.
