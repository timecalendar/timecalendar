# mobile-activity-triggers Specification

## Purpose
Define the mobile events that refresh Activity, their force and failure-visibility policies,
and the dependency direction that keeps all triggers on one single-flight data seam.
## Requirements
