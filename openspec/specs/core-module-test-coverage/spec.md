# core-module-test-coverage Specification

## Purpose
Defines the nominal (happy-path) regression test coverage for the Flutter app's
core modules — calendar, event_details, school, settings and onboarding — plus
the shared domain-object fixtures those tests rely on.
