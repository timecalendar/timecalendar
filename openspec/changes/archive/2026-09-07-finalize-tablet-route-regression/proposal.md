...
- **E2E proof:** the shared Activity Maestro flow and its static selector suite gain a deterministic route-transition oracle; no production UI or data behavior changes.
