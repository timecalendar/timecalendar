...
- [x] 7.6 Push the implementation and verify the normal mobile CI checks at the exact branch head; fix TypeScript, lint, Jest/coverage, generated-client drift, commit-identity, and disclosure failures before review handoff, reporting path-gated native jobs as skipped unless they actually ran.
