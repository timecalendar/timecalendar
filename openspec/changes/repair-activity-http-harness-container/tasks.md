...
- [x] 5.4 Hand the merged repair back to the release-readiness owner with an explicit note that prior candidate-bound evidence is invalid and a new full SHA plus all affected head-bound evidence must be frozen and rerun.
